...
public class InitMessageRepository {
    ...
    public static  int ReReadMsgTemplates(Logger AppThead_log )  {
        ...
        try {
            AppThead_log.info("SELECT * FROM ARTX_PROJ.MESSAGE_TemplateS T where T.LastDate > to_date('" + DataAccess.dateFormat.format( DataAccess.InitDate )  +"', 'YYYY-MM-DD HH:MI:SS' );" );
