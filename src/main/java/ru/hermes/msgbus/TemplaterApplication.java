...
public class TemplaterApplication implements CommandLineRunner {
    ...
    public static final Logger AppThead_log = LoggerFactory.getLogger(ru.hermes.msgbus.TemplaterApplication.class);
    ...
    public void run(String... strings) throws Exception {
       ...
       // ApplicationContext context = new AnnotationConfigApplicationContext(Sender_AppConfig.class);
        ...
        Connection Target_Connection = DataAccess.make_Hermes_Connection(  connectionProperties.gethrmsPoint(),
